# Generated by Django 3.1.1 on 2022-04-20 21:01
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall_type', models.CharField(choices=[
                 ('AC', 'AC'), ('Open Roof', 'Open Roof'), ('Closed Roof', 'Closed Roof')], max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Concert',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hall', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='concerts.hall')),
                ('concert', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='concerts.concert')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('show', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='concerts.show')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('city', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, to='concerts.city')),
            ],
        ),
        migrations.AddField(
            model_name='hall',
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to='concerts.theatre'),
        ),
        migrations.AddField(
            model_name='user',
            name='city',
            field=models.ForeignKey(
                null=True, on_delete=django.db.models.deletion.CASCADE, to='concerts.city'),
        ),
        migrations.AddField(
            model_name='user',
            name='groups',
